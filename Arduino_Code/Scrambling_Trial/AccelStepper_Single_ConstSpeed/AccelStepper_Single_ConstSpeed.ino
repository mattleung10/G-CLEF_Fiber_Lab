...
const float t_delay_1 = 100; //stepper 1 delay in [ms]
const float t_delay_2 = 100; //stepper 2 delay in [ms]
float pos_1 = 180.0; //stepper 1 target position [degrees]
float pos_2 = 360.0; //stepper 2 target position [degrees]
const float T_HP_1 = 1.0; //stepper 1 half-period [s]
