...
const float T_1 = 0.5; //stepper 1 period [s]
const float T_2 = 1.0; //stepper 2 period [s]
const float t_r1 = 0.2; //stepper 1 acceleration rise time [s] (same as the fall time)
const float t_r2 = 0.2; //stepper 1 acceleration rise time [s] (same as the fall time)
int omega_1 = 0; //stepper 1 velocity [steps/s]
int omega_2 = 0; //stepper 2 velocity [steps/s]
int omegadot_1 = 0; //stepper 1 acceleration [steps/s^2]
int omegadot_2 = 0; //stepper 2 acceleration [steps/s^2]
...
void setup() {
    ...
    omegadot_1 = (int) ((float)theta_1 / (t_r1 * (T_1 - t_r1)));
    omegadot_2 = (int) ((float)theta_2 / (t_r2 * (T_2 - t_r2)));
