...
const float t_delay_1 = 100;
unsigned int theta_1 = 200 * scale_factor; //stepper 1 target position
...
const float t_r1 = 0.1; //stepper 1 acceleration rise time [s] (same as the fall time)
const float t_r2 = 0.1; //stepper 1 acceleration rise time [s] (same as the fall time)
