...
int stepper2speed = 400 * scale_factor;
int stepper1accel = 1000 * scale_factor;
int stepper2accel = 2000 * scale_factor;
int stepper1targetpos = 100 * scale_factor;
int stepper2targetpos = 100 * scale_factor;
...
void setup() {
    ...
    stepper1.setAcceleration(stepper1accel);
    stepper2.setAcceleration(stepper2accel);
...
void loop() {
    ...
    if (stepper2.distanceToGo() == 0) {
        stepper2speed = -1 * stepper2speed;
        stepper2accel = -1 * stepper2accel;
        stepper2targetpos = -1 * stepper2targetpos;
        stepper2.moveTo(stepper2targetpos);
        stepper2.setSpeed(stepper2speed);
        stepper2.setAcceleration(stepper2accel);
    }
    stepper1.run();
