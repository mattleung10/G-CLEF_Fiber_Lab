...
if __name__ == "__main__":
    ...
    filename = 'Images/20220413_141650.tif' #octagonal, mode scrambler off
    #filename = 'Images/20220413_143326.tif' #octagonal, mode scrambler on
    ...
    #img = img[350:700,800:1100] #for square fiber
    #img = img[200:800,800:1150] #for rect fiber
    img = img[225:400,800:975] #for octagonal
    ...
    plt.savefig(os.path.join(savedir, filebasename+'_og.png'), bbox_inches='tight')
    plt.show()
    ...
    plt.savefig(os.path.join(savedir, filebasename+'_canny.png'), bbox_inches='tight')
    plt.show()
    ...
    plt.savefig(os.path.join(savedir, filebasename+'_alphashape.png'), bbox_inches='tight')
    plt.show()
    ...
    if plot_delaunay:
        ...
        plt.savefig(os.path.join(savedir, filebasename+'_delaunay.png'), bbox_inches='tight')
        plt.show()
    ...
    plt.savefig(os.path.join(savedir, filebasename+'_boundary.png'), bbox_inches='tight')
    plt.show()
    
    
    hull_mask = np.zeros(shape=img8.shape)
    cv.drawContours(hull_mask, [np.array(contour_points)], 0, (255, 255, 255), -1)
    hull_mask /= 255
