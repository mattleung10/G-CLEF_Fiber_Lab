...
if __name__ == "__main__":
    ...
    ms = 5
    pltcolor = 'dimgrey'
    ax[0].scatter(on_num_frames, on_snr, color='tab:blue',  linewidth=mew, edgecolor='k', label='Scrambler ON', zorder=5)
    ax[0].errorbar(on_unique_num_frames, on_ms_means, yerr=on_ms_stds, fmt='-', markersize=ms, ecolor=pltcolor, elinewidth=1, color=pltcolor, capsize=4, markeredgewidth=mew, markeredgecolor='k', zorder=4)
    ...
    ax[1].scatter(off_num_frames, off_snr, color='tab:orange', linewidth=mew, edgecolor='k', label='Scrambler OFF', zorder=5)
    ax[1].errorbar(off_unique_num_frames, off_ms_means, yerr=off_ms_stds, fmt='-', markersize=ms, ecolor=pltcolor, elinewidth=1, color=pltcolor, capsize=4, markeredgewidth=mew, markeredgecolor='k', zorder=4)
    ...
    mpl.rcParams.update(mpl.rcParamsDefault) #restore default params
